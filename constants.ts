...
import { CheckCircleIcon, ClockIcon, CogIcon, CloudArrowUpIcon, LockClosedIcon, RocketLaunchIcon, ScaleIcon, ShieldCheckIcon, SparklesIcon } from './components/icons.tsx'; // Added .tsx
...
export const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    overageDescription: 'Billed automatically for additional usage at a discounted rate.',
  },
  {
    id: 'enterprise',
    name: 'Enterprise',
...
export const FEATURE_ITEMS: FeatureItem[] = [
 {
    ...
    description: 'Our API processes PDFs and returns thumbnails in milliseconds, ensuring a smooth user experience.',
  },
  {
    icon: React.createElement(ScaleIcon, { className: "h-8 w-8" }),
    title: 'Scalable Infrastructure',
    description: 'Built to handle millions of requests, our infrastructure scales with your needs, from small projects to enterprise loads.',
  },
  {
    icon: React.createElement(CogIcon, { className: "h-8 w-8" }),
    title: 'Easy Integration',
    description: 'Simple REST API with clear documentation and client libraries for popular languages. Integrate in minutes!',
  },
  {
    icon: React.createElement(ShieldCheckIcon, { className: "h-8 w-8" }),
    title: 'Privacy First: Zero File Retention',
    description: 'Your PDF files are processed in memory and never stored on our servers, ensuring maximum privacy and security for your sensitive documents.',
  },
  {
    icon: React.createElement(SparklesIcon, { className: "h-8 w-8" }),
    title: 'AI-Powered Integration (Coming Soon)',
    description: "Future-ready: We're enabling AI agents to intelligently interact with our API (e.g., via MCP), making automated PDF thumbnail workflows even smarter.",
  },
  {
    ...
    description: 'We ensure high uptime and secure processing, with data privacy as a top priority for all thumbnail generations.',
  },
  {
    icon: React.createElement(LockClosedIcon, { className: "h-8 w-8" }),
    title: 'Developer Friendly',
    description: 'Clear documentation, fair pricing, and responsive support to help you succeed.',
  },
  {
    icon: React.createElement(CheckCircleIcon, { className: "h-8 w-8" }),
    title: 'High Quality Thumbnails',
    description: 'Generate crisp, clear thumbnails perfect for previews, galleries, and document management systems.',
  }
];