...
const PricingSection: React.FC = () => {
  ...
  return (
    <section id="pricing" className="py-16 sm:py-24 bg-white dark:bg-slate-800"> 
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-slate-600 dark:text-slate-300 max-w-xl mx-auto">
            Choose a plan that fits your needs. Start for free, then scale as you grow.
          </p>
        </div>
        ...
        <div className="flex justify-center mb-10">
          <div className="bg-slate-100 dark:bg-slate-700 p-1 rounded-lg flex space-x-1 shadow-inner">
            ...
            >
              Annually
              {PRICING_TIERS.some(tier => tier.priceYearly && tier.annualDiscountText) && (
                <span className="ml-2 px-2 py-0.5 bg-green-200 dark:bg-green-700 text-green-700 dark:text-green-200 text-xs rounded-full hidden sm:inline-block">SAVE</span>
              )}
            </button>
          </div>
        </div>
