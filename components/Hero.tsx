...
const Hero: React.FC = () => {
  ...
  const secondaryVariantStyles = 'bg-indigo-100 text-indigo-700 hover:bg-indigo-200 focus:ring-indigo-500 dark:bg-slate-700 dark:text-indigo-300 dark:hover:bg-slate-600 dark:focus:ring-indigo-400';
    ...
    <section className="bg-gradient-to-br from-slate-50 to-sky-100 dark:from-slate-800 dark:to-sky-900 py-20 md:py-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-slate-800 dark:text-slate-100 leading-tight">
          Instant <span className="text-indigo-600 dark:text-indigo-400">PDF Thumbnails</span>,
          <br className="hidden sm:block" />
          Effortlessly via API
        </h1>
        <p className="mt-6 max-w-2xl mx-auto text-lg md:text-xl text-slate-600 dark:text-slate-300">
          Focus on your application's core features. Let our robust API handle fast,
          reliable PDF thumbnail generation at scale.
        </p>
